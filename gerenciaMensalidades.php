...
<body>
    ...
    <div class="container w-auto text-dark bg-white">
        <ul class="nav nav-tabs w-auto">
            <li class="nav-item">
              <a class="nav-link text-dark bg-white border-dark" href="cadastroLocador.php">Cadastrar Locador</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link active text-white bg-secondary border-dark" href="#">Mensalidades</a>
            </li>
        </ul>
